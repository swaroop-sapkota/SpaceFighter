...
public class GetKeyObjectiveLevel2 : MonoBehaviour
{
    ...
    public static bool material4Found; // NEW
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        {
            bool allMaterialsFound = material1Found && material2Found && material3Found && material4Found;
