...
public class Level2EnemySpawner : MonoBehaviour
{
    ...
    private IEnumerator SpawnEnemies()
    {
        while (EnemyCount < 4)
        {
            ...
            float xPos1 = Random.Range(-90, 90);
            float zPos1 = Random.Range(40, -80);

            float xPos2 = Random.Range(-30, -60);
            float zPos2 = Random.Range(30, -45);

            float xPos3 = Random.Range(70, 120);
            float zPos3 = Random.Range(40, 100);

            float xPos4 = Random.Range(45, -45);
            ...
            float xPos6 = Random.Range(-30, -60);
            float zPos6 = Random.Range(30, -45);
            ...
            Instantiate(Enemy5, pos6, Quaternion.identity);
